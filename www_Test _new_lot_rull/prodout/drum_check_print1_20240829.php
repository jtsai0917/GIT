...
//		echo "1<BR>";
		...
		$objPHPExcel->getActiveSheet()->setCellValue("O".$y,iconv("big5","utf-8",$row['OPD_LOT_NO']));
		$objPHPExcel->getActiveSheet()->setCellValue("F".$y,iconv("big5","utf-8",$row['OPD_LOT_NO']));
		$x++;
...
//	echo "2<BR>";
	...
	$objPHPExcel->getActiveSheet()->setCellValue("L2",iconv("big5","utf-8",$cust) );
...
//		echo $query."<BR>";
		...
		while($row = mssql_fetch_array($result))
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValue("C2",iconv("big5","utf-8",$row['OCM_CHK_DATE']) );
			$objPHPExcel->getActiveSheet()->setCellValue("G2",iconv("big5","utf-8",substr($eta_date,0,8)) );
