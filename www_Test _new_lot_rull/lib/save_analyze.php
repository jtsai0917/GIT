...
//			echo $queryd."<BR>";
	...
	if($numRows<1 and $dun==0){
		$query="INSERT INTO dbo.AnalyzeDesign
                            (sample_metal_f, sample_particle_f, CTD_CUST_NO, AND_RESULT,AND_RESULT_DATETIME,AND_GET_DATETIME,AND_GET_QTY,AND_MARK,AND_VALUE,AND_ANA_ID,AND_APPLY_DATE, AND_NEED_NO, AND_LOT_NO, AND_GOODS, AND_BEFORE, AND_SMP_DATETIME, AND_ITEM, AND_NOTE, AND_TOTAL, AND_OUT_QTY, AND_OUT_DATETIME, AND_REPORT_DATETIME, AND_PERSON, AND_SELECT_TYPE, AND_ITEM_ORI)
	  VALUES          (".$_GET['sample_metal_f'].",".$_GET['sample_particle_f'].",'".$cid."','','','',0,'".'0'."','','','".date("Ymd")."',1,'".$_GET['lot_no']."','".$_GET['pid']."','N','".$_GET['datepicker1']."','". Regular_item($pid,$cid,$test_items)."','',".$_GET['smp_cnt'].",0,'','".$_GET['out_date']."','".$_SESSION['uid']."','".$_GET['item_style']."','".$_SESSION['item_ori']."')";
		echo $query;
		echo "<BR>";
		$result = mssql_query($query);
	}
	elseif($numRows<1 and $dun==1){
			...
			$query="INSERT INTO dbo.AnalyzeDesign
								(sample_metal_f, sample_particle_f, CTD_CUST_NO, AND_RESULT,AND_RESULT_DATETIME,AND_GET_DATETIME,AND_GET_QTY,AND_MARK,AND_VALUE,AND_ANA_ID,AND_APPLY_DATE, AND_NEED_NO, AND_LOT_NO, AND_GOODS, AND_BEFORE,AND_SMP_DATETIME, AND_ITEM, AND_NOTE, AND_TOTAL, AND_OUT_QTY, AND_OUT_DATETIME, AND_REPORT_DATETIME, AND_PERSON, AND_SELECT_TYPE, AND_ITEM_ORI)
		  VALUES          (".$_GET['sample_metal_f'].",".$_GET['sample_particle_f'].",'".$cid."','','','',0,'".'0'."','','','".date("Ymd")."',1,'".$_GET['lot_no']."','".$_GET['pid']."','N','".$_GET['datepicker1']."','". Get_Drum_All($pid,$cid,$test_items)."','',".$_GET['smp_cnt'].",0,'','".$_GET['out_date']."','".$_SESSION['uid']."','".$_GET['item_style']."','".$_SESSION['item_ori']."')";
		echo $query;
			echo "<BR>";
		 $result = mssql_query($query);
			...
			$query="INSERT INTO dbo.AnalyzeDesign
								(sample_metal_f, sample_particle_f, CTD_CUST_NO,AND_RESULT,AND_RESULT_DATETIME,AND_GET_DATETIME,AND_GET_QTY,AND_MARK,AND_VALUE,AND_ANA_ID,AND_APPLY_DATE, AND_NEED_NO, AND_LOT_NO, AND_GOODS, AND_BEFORE, AND_SMP_DATETIME, AND_ITEM, AND_NOTE, AND_TOTAL, AND_OUT_QTY, AND_OUT_DATETIME, AND_REPORT_DATETIME, AND_PERSON, AND_SELECT_TYPE, AND_ITEM_ORI)
		  VALUES          (".$_GET['sample_metal_f'].",".$_GET['sample_particle_f'].",'".$cid."','','','',0,'".'0'."','','','".date("Ymd")."',1,'".$_GET['lot_no']."_','".$_GET['pid']."','N','".$_GET['datepicker1']."','". get_test_item($pid,$cid,$test_items)."','',".$_GET['smp_cnt'].",0,'','".$_GET['out_date']."','".$_SESSION['uid']."','".$_GET['item_style']."','".$_SESSION['item_ori']."')";
		 echo $query;
			echo "<BR>";
		 $result = mssql_query($query); 
	}	
