...
//  echo $query1;
			...
			while ($row1 = mssql_fetch_array($result1))
			{
				...
				$query2="select SMA_DRUMNO from Sample_All where SMA_LOT='".$row1['LotNo']."' and SMA_ID='".$row1['SampleNo']."'";
				//echo $query2.'<br>';
				...
				echo '<td>'.get_uname($row1['sampler']).'</td>';
				...
				$objPHPExcel->getActiveSheet()->setCellValue($ENG.$NUM, iconv("big5","utf-8",get_uname($row1['sampler'])));$ENG++;
