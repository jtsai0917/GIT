...
//	echo "PDD_TYPE=".$pdd->pdd_type;
  ...
  {	
  	if(substr($_GET['lot_no'],-1)=="_"){$lotid=substr($_GET['lot_no'],0,-1);}else{$lotid=$_GET['lot_no'];}
...
//	  if(substr($_GET['lot_no'],-1)=="_" and $_SESSION['select_cust']='C00001'){
//		  $_SESSION['cid']=$_SESSION['select_cust']='C00003';
//	  }
//	  else{
//			$_SESSION['cid']=$_SESSION['select_cust']='C00001';
//	  }
...
{   
	...
	echo $filename=$_GET['lot_no']."_".date("YmdHis").".".$ext;
