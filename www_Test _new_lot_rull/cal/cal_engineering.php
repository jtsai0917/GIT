...
<![endif]-->
<script src="../fill/css/respond.min.js"></script>
...
<div class="gridContainer clearfix">
  ...
  <div id="LayoutDiv1">
    <div id="banner">   
      <div id="logo"><img src="../pics/TYS.jpg" alt="logo" width="100" height="60"> 工程分析分項檢查作業表製作/查詢</div>
      <div id="logo_r"></div>
</div>
    <div id="menu">
