...
<form id="form1" name="form1" method="post" action="">
    ...
    <?php 
	if(trim($_GET['pdd_prod_no'])=='GM-CRP' or trim($_GET['pdd_prod_no'])=='GM-CRBP' or trim($_GET['pdd_prod_no'])=='MF-MLI' or trim($_GET['pdd_prod_no'])=='MF-HKO' or trim($_GET['pdd_prod_no'])=='BR-NBP')
	{
