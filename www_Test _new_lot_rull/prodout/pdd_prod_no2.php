...
<label for="pdd_pro_no"></label>
    <input name="pdd_pro_no" type="text" id="pdd_pro_no" size="8" />
   名稱 : 
   <label for="pdd_prod_name"></label>
   <input name="pdd_prod_name" type="text" id="pdd_prod_name" size="14" />
...
while($row = mssql_fetch_array($result))
{
	...
	echo '<td><a href="setsession_prod2.php?pro_no='.$row['PDD_PROD_NO'].'&pro_name='.$row['PDD_PROD_NAME'].'"  target="_self">選取</a></td>';
	echo "</tr>";
}
