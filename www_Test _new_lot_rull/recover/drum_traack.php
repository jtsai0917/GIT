...
~
<input name="datepicker6" type="text" id="datepicker5a" size="10" value="<?php if($_SESSION['datepicker6']){echo $_SESSION['datepicker6'];}?>" onChange="set_date_session(this.name,this.value)"></td>
抽殘液回收再判斷(Y/N): <input name="chk2" type="text" id="chk2" size="10"  />

		</br>
        </br>
D/M廢棄出廠日： <input name="datepicker7" type="text" id="datepicker7a" size="10" value="<?php if($_SESSION['datepicker7']){echo $_SESSION['datepicker7'];}?>" onChange="set_date_session(this.name,this.value)">
~
...
WHERE   DHN.DHN_DRUM_NO<>'' ";
			...
			if($_POST['lotno']<>''){$query=$query."and (DHN_LOT_NO1='".$_POST['lotno']."' or DHN_LOT_NO2='".$_POST['lotno']."' or DHN_LOT_NO3='".$_POST['lotno']."')";}
				...
				if($_SESSION['datepicker9']<>''){$query=$query." and DHN_CF_DISCARD_DATE>='".$date9."'
																 and DHN_CF_DISCARD_DATE<='".$date10."'";}																											
  ...
  <tr class="GridviewScrollHeader">';
			...
			$objPHPExcel->getActiveSheet()->setCellValue("F".$p, iconv("big5","utf-8","品名1"));
			$objPHPExcel->getActiveSheet()->setCellValue("G".$p, iconv("big5","utf-8","洗淨日1"));
			$objPHPExcel->getActiveSheet()->setCellValue("H".$p, iconv("big5","utf-8","充填日1"));
			$objPHPExcel->getActiveSheet()->setCellValue("I".$p, iconv("big5","utf-8","LOTNO1"));
			$objPHPExcel->getActiveSheet()->setCellValue("J".$p, iconv("big5","utf-8","出荷日1"));
			$objPHPExcel->getActiveSheet()->setCellValue("K".$p, iconv("big5","utf-8","藥品有效期限1"));
			$objPHPExcel->getActiveSheet()->setCellValue("L".$p, iconv("big5","utf-8","華立回收日期1"));
			$objPHPExcel->getActiveSheet()->setCellValue("M".$p, iconv("big5","utf-8","TYS回收日期1"));
			$objPHPExcel->getActiveSheet()->setCellValue("N".$p, iconv("big5","utf-8","回收判斷1"));
			$objPHPExcel->getActiveSheet()->setCellValue("O".$p, iconv("big5","utf-8","抽殘液日期1"));
			$objPHPExcel->getActiveSheet()->setCellValue("P".$p, iconv("big5","utf-8","抽殘液回收再判斷1"));			  
			  echo  '<td>'."用戶2".'</td>';
			  echo  '<td>'."料號2".'</td>';
			    echo  '<td>'."品名2".'</td>';
			  echo  '<td>'."洗淨日2".'</td>';
			 ...
			 echo  '<td>'."藥品有效期限2".'</td>';
			  ...
			  echo  '<td>'."抽殘液回收再判斷2".'</td>';
			   $objPHPExcel->getActiveSheet()->setCellValue("Q".$p, iconv("big5","utf-8","用戶2"));
			$objPHPExcel->getActiveSheet()->setCellValue("R".$p, iconv("big5","utf-8","料號2"));
			$objPHPExcel->getActiveSheet()->setCellValue("S".$p, iconv("big5","utf-8","品名2"));
			$objPHPExcel->getActiveSheet()->setCellValue("T".$p, iconv("big5","utf-8","洗淨日2"));
			$objPHPExcel->getActiveSheet()->setCellValue("U".$p, iconv("big5","utf-8","充填日2"));
			$objPHPExcel->getActiveSheet()->setCellValue("V".$p, iconv("big5","utf-8","LOTNO2"));
			$objPHPExcel->getActiveSheet()->setCellValue("W".$p, iconv("big5","utf-8","出荷日2"));
			$objPHPExcel->getActiveSheet()->setCellValue("X".$p, iconv("big5","utf-8","藥品有效期限2"));
			$objPHPExcel->getActiveSheet()->setCellValue("Y".$p, iconv("big5","utf-8","華立回收日期2"));
			$objPHPExcel->getActiveSheet()->setCellValue("Z".$p, iconv("big5","utf-8","TYS回收日期2"));
			$objPHPExcel->getActiveSheet()->setCellValue("AA".$p, iconv("big5","utf-8","回收判斷2"));
			$objPHPExcel->getActiveSheet()->setCellValue("AB".$p, iconv("big5","utf-8","抽殘液日期2"));
			$objPHPExcel->getActiveSheet()->setCellValue("AC".$p, iconv("big5","utf-8","抽殘液回收再判斷2"));
			   echo  '<td>'."用戶3".'</td>';
			    echo  '<td>'."料號3".'</td>';
			    echo  '<td>'."品名3".'</td>';
			  echo  '<td>'."洗淨日3".'</td>';
			  ...
			  echo  '<td>'."華立回收日期3".'</td>';
			   ...
			   echo  '<td>'."回收判斷3".'</td>';
			    echo  '<td>'."抽殘液日期3".'</td>';
				 ...
				 $objPHPExcel->getActiveSheet()->setCellValue("AD".$p, iconv("big5","utf-8","用戶3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AE".$p, iconv("big5","utf-8","料號3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AF".$p, iconv("big5","utf-8","品名3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AG".$p, iconv("big5","utf-8","洗淨日3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AH".$p, iconv("big5","utf-8","充填日3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AI".$p, iconv("big5","utf-8","LOTNO3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AJ".$p, iconv("big5","utf-8","出荷日3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AK".$p, iconv("big5","utf-8","藥品有效期限3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AL".$p, iconv("big5","utf-8","華立回收日期3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AM".$p, iconv("big5","utf-8","TYS回收日期3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AN".$p, iconv("big5","utf-8","回收判斷3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AO".$p, iconv("big5","utf-8","抽殘液日期3"));
			$objPHPExcel->getActiveSheet()->setCellValue("AP".$p, iconv("big5","utf-8","抽殘液回收再判斷3"));
			  echo  '<td>'."廢棄洗桶日".'</td>';
			   echo  '<td>'."D/M廢棄出廠日".'</td>';
			  echo  '<td>'."出場作業人員".'</td>';
			   echo  '<td>'."轉用日".'</td>';
			   ...
			   echo '</tr>';
			   $objPHPExcel->getActiveSheet()->setCellValue("AQ".$p, iconv("big5","utf-8","廢氣洗桶日"));
			$objPHPExcel->getActiveSheet()->setCellValue("AR".$p, iconv("big5","utf-8","D/M廢棄出廠日"));
			$objPHPExcel->getActiveSheet()->setCellValue("AS".$p, iconv("big5","utf-8","出場作業人員"));
			$objPHPExcel->getActiveSheet()->setCellValue("AT".$p, iconv("big5","utf-8","轉用日"));
			$objPHPExcel->getActiveSheet()->setCellValue("AU".$p, iconv("big5","utf-8","D/M廢棄再確認日"));
			$p++;
			...
			$objPHPExcel->getActiveSheet()->setCellValue("F".$p,iconv("big5","utf-8",$row['品名1']));
			$objPHPExcel->getActiveSheet()->setCellValue("G".$p,ttd($row['洗淨日1']));
			$objPHPExcel->getActiveSheet()->setCellValue("H".$p,ttd($row['充填日1']));
			$objPHPExcel->getActiveSheet()->setCellValue("I".$p,$row['LOT NO1']);
			$objPHPExcel->getActiveSheet()->setCellValue("J".$p,$row['出荷日1']);
			$objPHPExcel->getActiveSheet()->setCellValue("K".$p,$row['藥品有效期限1']);
			$objPHPExcel->getActiveSheet()->setCellValue("L".$p,ttd($row['華立回收日期1']));
			$objPHPExcel->getActiveSheet()->setCellValue("M".$p,ttd($row['TYS回收日期1']));
			$objPHPExcel->getActiveSheet()->setCellValue("N".$p,$row['回收判斷1']);
			$objPHPExcel->getActiveSheet()->setCellValue("O".$p,ttd($row['抽殘液日期1']));
			$objPHPExcel->getActiveSheet()->setCellValue("P".$p,$row['抽殘液回收再判斷1']);
			 ...
			 echo  '<td>'.ttd($row['充填日2']).'</td>';
			  ...
			  echo  '<td>'.ttd($row['TYS回收日期2']).'</td>';      
			   ...
			   echo  '<td>'.$row['抽殘液回收再判斷2'].'</td>';
			     $objPHPExcel->getActiveSheet()->setCellValue("Q".$p, iconv("big5","utf-8",$row['用戶2']));
			$objPHPExcel->getActiveSheet()->setCellValue("R".$p,iconv("big5","utf-8",$row['料號2']));
			$objPHPExcel->getActiveSheet()->setCellValue("S".$p,iconv("big5","utf-8",$row['品名2']));
			$objPHPExcel->getActiveSheet()->setCellValue("T".$p,ttd($row['洗淨日2']));
			$objPHPExcel->getActiveSheet()->setCellValue("U".$p,ttd($row['充填日2']));
			$objPHPExcel->getActiveSheet()->setCellValue("V".$p,$row['LOT NO2']);
			$objPHPExcel->getActiveSheet()->setCellValue("W".$p,ttd($row['出荷日2']));
			$objPHPExcel->getActiveSheet()->setCellValue("X".$p,ttd($row['藥品有效期限2']));
			$objPHPExcel->getActiveSheet()->setCellValue("Y".$p,$row['華立回收日期2']);
			$objPHPExcel->getActiveSheet()->setCellValue("Z".$p,ttd($row['TYS回收日期2']));
			$objPHPExcel->getActiveSheet()->setCellValue("AA".$p,$row['回收判斷2']);
			$objPHPExcel->getActiveSheet()->setCellValue("AB".$p,ttd($row['抽殘液日期2']));
			$objPHPExcel->getActiveSheet()->setCellValue("AC".$p,$row['抽殘液回收再判斷2']);
			 ...
			 echo  '<td>'.ttd($row['充填日3']).'</td>';
			  ...
			  echo  '<td>'.ttd($row['TYS回收日期3']).'</td>';      
			   ...
			   $objPHPExcel->getActiveSheet()->setCellValue("AD".$p, iconv("big5","utf-8",$row['用戶3']));
			$objPHPExcel->getActiveSheet()->setCellValue("AE".$p,iconv("big5","utf-8",$row['料號3']));
			$objPHPExcel->getActiveSheet()->setCellValue("AF".$p,iconv("big5","utf-8",$row['品名3']));
			$objPHPExcel->getActiveSheet()->setCellValue("AG".$p,ttd($row['洗淨日3']));
			$objPHPExcel->getActiveSheet()->setCellValue("AH".$p,ttd($row['充填日3']));
			$objPHPExcel->getActiveSheet()->setCellValue("AI".$p,$row['LOT NO3']);
			$objPHPExcel->getActiveSheet()->setCellValue("AJ".$p,ttd($row['出荷日3']));
			$objPHPExcel->getActiveSheet()->setCellValue("AK".$p,ttd($row['藥品有效期限3']));
			$objPHPExcel->getActiveSheet()->setCellValue("AL".$p,ttd($row['華立回收日期3']));
			$objPHPExcel->getActiveSheet()->setCellValue("AM".$p,ttd($row['TYS回收日期3']));
			$objPHPExcel->getActiveSheet()->setCellValue("AN".$p,$row['回收判斷3']);
			$objPHPExcel->getActiveSheet()->setCellValue("AO".$p,ttd($row['抽殘液日期3']));
			$objPHPExcel->getActiveSheet()->setCellValue("AP".$p,ttd($row['抽殘液回收再判斷3']));
			  ...
			  echo  '<td>'.$row['出廠作業人員'].'</td>';
			   echo  '<td>'.$row['轉用日'].'</td>';
				...
				echo '</tr>';
				$objPHPExcel->getActiveSheet()->setCellValue("AQ".$p,$row['廢棄洗桶日']);
			$objPHPExcel->getActiveSheet()->setCellValue("AR".$p,$row['D/M廢棄出廠日']);
			$objPHPExcel->getActiveSheet()->setCellValue("AS".$p,$row['出廠作業人員']);
			$objPHPExcel->getActiveSheet()->setCellValue("AT".$p,$row['轉用日']);
			$objPHPExcel->getActiveSheet()->setCellValue("AU".$p,$row['D/M廢棄再確認日']);
			$p++;
			$rr++;
...
<meta http-equiv="Content-Type" content="text/html; charset=big5" />
  ...
  <script type="text/javascript">
	...
	$( "#datepicker5a" ).datepicker({
      changeMonth: false,
      changeYear: true
    });
	 $( "#datepicker7a" ).datepicker({
      changeMonth: true,
      changeYear: true
    });
  });
