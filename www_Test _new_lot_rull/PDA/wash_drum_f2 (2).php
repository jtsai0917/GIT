...
$query="SELECT  COUNT(*) AS cnt FROM	EL_WASH_DRUM	WHERE   (FDM_LOT_NO = '".$_SESSION['lid']."')";
// echo $query."<BR>";
$result=mssql_query($query);
...
// P1	
	...
	echo '<input type="button" name="X" id="X" style="width:120px;height:40px;border:2px orange double;" value="上 一 步" onClick="window.open('."'wash_drum_f1.php ', '_self'".');"><input type="button" name="X1" id="X1" style="width:120px;height:40px;border:2px orange double;" value=" 結 束 " onClick="window.open('."'fill.php ', '_self'".');"></br></form>';
