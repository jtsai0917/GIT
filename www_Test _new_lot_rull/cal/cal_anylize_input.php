...
$a2=array_user_group($_SESSION['uid'],'製造課長');
      ...
      <td width="480">要求日期 
        ...
        <label for="dep"></label>
          <select name="dep" id="dep">
            ...
            <option value="1" selected="selected">排除分析課內</option>
          </select>
        &nbsp;&nbsp;&nbsp;
...
if($_POST['dep']==1){
	$query=$query." AND (PRODUCT_TYPE.department != 'EL分析課內') ";
	// EL分析課內
}
if ($_POST['textfield4']<>""){
	...
	$_SESSION['datepicker1']=$_POST['datepicker1'];
    $query=$query." AND (substring(AnalyzeDesign.AND_SMP_DATETIME,0,12) >='".dod($_POST['datepicker1'])."0000')";
}
elseif($_SESSION['datepicker1'])
{
	$query=$query." AND (substring(AnalyzeDesign.AND_SMP_DATETIME,0,12) >='".dod($_SESSION['datepicker1'])."0000')";
}
if ($_POST['datepicker2']){
	$_SESSION['datepicker2']=$_POST['datepicker2'];
	$query=$query." AND ( substring(AnalyzeDesign.AND_SMP_DATETIME,0,12) <='".dod($_POST['datepicker2'])."9999')";
}
elseif($_SESSION['datepicker2']){
	$query=$query." AND ( substring(AnalyzeDesign.AND_SMP_DATETIME,0,12) <='".dod($_SESSION['datepicker2'])."9999')";
}
}
if($_POST['urgent1']=='on'){
