...
<form id="form1" name="form1" method="post" action="<?php echo $loginFormAction; ?>">
  ...
  <table border="0" width="700">
	...
	$_SESSION['sample_metal_f']=$metal;}
      ...
      <tr><td width="100">品名；<?php echo get_pdd_name($_GET['pid']);?></td><td width="500"></td></tr>
      <tr><td width="100">LY-NO:<?php echo $_GET['lyno'];?></td><td width="500">PCN LOT <input type="checkbox" name="pcn"></td></tr>
...
WHERE   (FILL_INDICATE.FDM_LOT_NO = '".$_POST['lot_no']."')";
	...
	///檢查有沒有依賴				{
				...
				if($_POST['select_test_items']=='0')
					{
						$ull='../lib/save_analyze_new.php?datepicker1='.dod($_POST['datepicker1'])."1000&comfirm=Y&cid=".$_GET['cid']."&pid=".$_GET['pid']."&out_date=".$_POST['datepicker3'].$_POST['time3'].$_POST['time32']."&pcn=".$_POST['pcn'].
				...
				elseif($_POST['select_test_items']=='1')
					{
						...
						$items->pid=$_GET['pid'];
						$items->get_rull_1();
						$ull='../lib/save_analyze_new.php?datepicker1='.dod($_POST['datepicker1'])."1000&comfirm=Y&cid=".$_GET['cid']."&pid=".$_GET['pid']."&out_date=".$_POST['datepicker3'].$_POST['time3'].$_POST['time32']."&lot_no=".$_POST['lot_no']."&pcn=".$_POST['pcn'].
						"&out_date=".$s1."&testitems=".$_aniitems."&smp_cnt=".$_SESSION['smp_total']."&item_style=".$_SESSION['select_test_items']."&sample_metal_f=".$_SESSION['sample_metal_f']."&sample_particle_f=".$_SESSION['sample_particle_f'];
						jumpto($ull); 
					}
