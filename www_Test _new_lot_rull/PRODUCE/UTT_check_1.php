...
function hr_duteies($val)
{
	...
	if(substr($_SESSION['uid'],1)=='319' or substr($_SESSION['uid'],1)=='1048' or substr($_SESSION['uid'],1)=='1303' or substr($_SESSION['uid'],1)=='1263'){$_SESSION['director']=1;$sign1[1]='<input type="submit" name="sign2" value="批次簽核" style="background-color:green;">';
