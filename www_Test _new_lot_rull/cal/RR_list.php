...
WHERE          (AnalyzeDesign.AND_NEED_NO>=150 and AnalyzeDesign.AND_NEED_NO<270) and (AnalyzeDesign.AND_LOT_NO like '%RR%' ) ";
...
echo '<a target="_self" href=index.php?url=input_reportRR&lot_no='.$lot_no."&pdd_prod_no=".$pdd_prod_no."&ani_groupname=".
