...
<td><input type="checkbox" name="chkbox[]" id="1" value="<?php echo $row['ANI_FULLNAME'].",".$row['ANI_GROUPNAME'] ?>" <?php echo testnotonick($row['ANI_FULLNAME'],$_SESSION['prod_no'],$_SESSION['items'].",")?>/></td></tr>
<?php
}
?>
</table>
