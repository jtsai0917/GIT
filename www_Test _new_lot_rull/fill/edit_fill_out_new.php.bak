...
if(isset($_POST["leave"])){
	...
	echo "<script type='text/javascript'>
		...
		window.open('index.php?url=fill_out_plan_new','_self')
		</script>
		";
...
WHERE   (FILL_INDICATE.FDM_LOT_NO = '".$_POST['lot_no']."')";
	...
	///檢查有沒有依賴				{
				...
				if($_POST['select_test_items']=='0')
					{
						$ull='../lib/save_analyze_new.php?datepicker1='.dod($_POST['datepicker1'])."1000&comfirm=Y&cid=".$_GET['cid']."&pid=".$_GET['pid']."&out_date=".$_POST['datepicker3'].$_POST['time3'].$_POST['time32'].
