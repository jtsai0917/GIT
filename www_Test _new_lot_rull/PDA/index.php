...
$_SESSION['lid']=$_SESSION['rdrum_id']='';
datepick();
?><head>
...
if(actualkey=="6"){location.href="sample_location.php";}
if(actualkey=="7"){location.href="drum_return.php";}
}
...
<p><strong><a href="sample_location.php">6. 樣品瓶站點作業</a></strong></p>
<p><strong><a href="drum_return.php">7. DRUM 桶回收 </a></p>
