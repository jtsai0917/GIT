...
if(isset($_POST['start'])){
	$query="INSERT INTO IN2OUT_CAL_TOTO_CHECK
				...
				VALUES  ('".$_GET['fod_lot']."','".$_GET['stock_lot']."','".$_GET['stock_toto']."','".$_GET['fod_toto'].
				"','Y','Y',".$_GET['T2M_W_I_WEIGHT'].",".$_GET['T2M_W_O_WEIGHT'].",'Y','Y','Y','Y','Y','Y','Y','".
				$now1."','','Y',".$_POST['purge_qty'].",".$cnt.",'N','N','N','N','N','N','".$_SESSION['uid'].
				"','N',0,'N')";
//		echo "<BR>".$query."<BR>";
		echo '<BR>';
		$result=mssql_query($query);
