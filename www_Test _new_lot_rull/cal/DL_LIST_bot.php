...
$query="SELECT DISTINCT 
                           AnalyzeDesign.AND_LOT_NO AS LOT_NO, AnalyzeDesign.AND_APPLY_DATE,
...
WHERE          (AnalyzeDesign.AND_NEED_NO>=150 and AnalyzeDesign.AND_NEED_NO<270) and (AnalyzeDesign.AND_LOT_NO like '%DL%' ) ";
...
if ($_POST['textfield4']<>""){
	...
	$_SESSION['datepicker1']=$_POST['datepicker1'];
    $query=$query." AND (SUBSTRING(AnalyzeDesign.AND_SMP_DATETIME, 1, 12) >='".dod($_POST['datepicker1'])."0000')";
}
elseif($_SESSION['datepicker1'])
{
	$query=$query." AND (SUBSTRING(AnalyzeDesign.AND_SMP_DATETIME, 1, 12) >='".dod($_SESSION['datepicker1'])."0000')";
}
if ($_POST['datepicker2']){
	$_SESSION['datepicker2']=$_POST['datepicker2'];
	$query=$query." AND ( SUBSTRING(AnalyzeDesign.AND_SMP_DATETIME, 1, 12) <='".dod($_POST['datepicker2'])."2359')";
}
elseif($_SESSION['datepicker2']){
	$query=$query." AND ( SUBSTRING(AnalyzeDesign.AND_SMP_DATETIME, 1, 12) <='".dod($_SESSION['datepicker2'])."2359')";
}
}
...
echo '<a target="_self" href=index.php?url=input_report4&lot_no='.$lot_no."&pdd_prod_no=".$pdd_prod_no."&ani_groupname=".
