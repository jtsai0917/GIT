...
elseif($_POST['class_type']=='P'){$query.=" WHERE          (AnalyzeDesign.AND_NEED_NO>=270) ";}
...
<table width="1240" border="1">
  <tr bgcolor="#CCCCCC">
    <td width="49" width="80">日期序號</td>
    <td width="76">客戶</td>
    <td width="84">品名</td>
    <td width="29">容器</td>
    <td width="67">LotNO</td>
    <td width="28">定常</td>
    <td width="603">僅用於輸入用‧ 點選分析群組名稱可以進入輸入分析資料畫面. 分析項目本身不會有顏色變化用來區別分析及報告的狀況</td>
