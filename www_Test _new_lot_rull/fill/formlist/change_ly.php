...
SET                   FLM_DAY".$_POST['day']." = '".$myallsport."'
WHERE          (CTD_CUST_NO = '".$_POST['cn']."') AND (PDD_PROD_NO = '".$_POST['pn']."') AND (FLM_YEAR_MONTH = '".$_POST['ym']."')";
//echo "更新:".$query."</br>";
$result = mssql_query($query);
	}
...
$fodday=$fodym=$flo='';
			...
			$q2=$q2.$q;
echo "num1:".$numRows."</br>";

if($numRows<1){
		$query="INSERT INTO dbo.FILLPLAN_OUT_DECIDE
                            (FOD_YEAR_MONTH, FOD_DAY, FOD_O_YEAR_MONTH, FOD_O_DAY, CTD_CUST_NO, PDD_PROD_NO, FDM_LY_NO, FDM_CREATE_DATE, FDM_CREATOR, FDM_SPECIFIC, FDM_QTY_UNIT, FDM_PURGE)
				VALUES          ('".$_POST['ym']."','".$_POST['day']."','".$_POST['ym']."','".$_POST['day']."','".$_POST['cn']."','".$_POST['pn']."','".$sport[$x]."','".date("Ymdhis")."','".$_SESSION['uid']."','LY','KG','0')";
				echo "插入:".$query."</br></br>";				
		$result = mssql_query($query);	
	}
}
