  ...
  <table width="1240" border="1">
    <tr>
      <td width="480">要求日期 
		...
		$d=strtotime("-0 Days"); echo $_SESSION['datepicker1']=date("m/d/Y",$d);
		}
		?>">
        ~
		...
		$d=strtotime("+0 Days"); echo $_SESSION['datepicker2']=date("m/d/Y",$d);
		}
		?>">
...
WHERE          (AnalyzeDesign.AND_NEED_NO>149) and (AnalyzeDesign.AND_NEED_NO<250)";
