...
//	echo "<BR>";
	list ($spec,$dl,$usl,$stdu,$ps,$stdl,$lsl)=get_test_spec($row['ANI_DATAFIELD'],$pid,$cust_no,$ani_group);
...
//	$spc='________';	$unit='________';  $dl='________';
	...
	if($ani_nick=='Au')
	{
		...
		$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValue("'D".$au."'",sprintf("%f",$report))
	...
	$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValue("'D".$i."'", sprintf("%f",$report))
