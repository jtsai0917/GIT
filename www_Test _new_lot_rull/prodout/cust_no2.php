...
while($row = mssql_fetch_array($result))
{
	...
	echo '<td><a href="setsession_cust2.php?cust_no='.$row['CTD_CUST_NO'].'&pro_name='.$row['CTD_CUST_NAME'].'"  target="_self">選取</a></td>';
	echo "</tr>";
}
...
<table width="350" border="1">
<tr>
  <td align="center"><input type="submit" name="submit2" id="submit2" value=" 選擇完成 " /></td></tr></table>
</form>
</body>
</html>
