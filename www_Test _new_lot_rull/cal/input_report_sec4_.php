...
if($_GET['ani_groupname']=='NH4' or $_GET['ani_groupname']=='IC' or $_GET['ani_groupname']=='F-' or $_GET['ani_groupname']=='ICGA')//特別列印
{
	...
	$objPHPExcel->getActiveSheet()->setCellValue("A2","DATE  ".substr($row['AnalyzeTime'],0,8) );
				...
				{
					if($num2>'17'){
					$objPHPExcel->getActiveSheet()->setCellValue($eng.'20',$row['Acetate']);$eng++;
					$objPHPExcel->getActiveSheet()->setCellValue($eng.'20',$row['Formate']);$eng++;
					$objPHPExcel->getActiveSheet()->setCellValue($eng.'20',$row['Propionate']);$eng++;}
					else{
