...
while($row = mssql_fetch_array($result))
	{
    	...
    	echo '<td><input type="checkbox" name="chkbox[]" id="1" value="'.$otdno.",".$OPD_LOT_NO.'" '.$ch.' /><input type="hidden" name="lotno[]" value="'.$OPD_LOT_NO.'"></td></tr>';
	}
	echo '</table>';
}
//   echo "<BR>".$query."<BR>";
...
WHERE          (FILLPLAN_OUT_DECIDE.FDM_LOT_NO = '".trim($lno)."')";
