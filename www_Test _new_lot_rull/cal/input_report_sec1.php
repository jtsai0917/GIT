...
if(trim($_SESSION['SampleNo'])=='' and $_SESSION['SampleNoss']=='')	{$_SESSION['SampleNo']=$pdd_short_name;}
?>

      <input name="SampleNo" type="text" id="SampleNo" value="<?php 
	  		if($_SESSION['SampleNo']==''){echo trim($_SESSION['SampleNoss']);}
			else{echo trim($_SESSION['SampleNo']);}
		?>" size="10"  onchange="set_date_session(this.name,this.value)"/>
