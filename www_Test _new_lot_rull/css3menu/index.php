...
<?php
 if(substr($_SESSION['uid'],0,1)<>'H'){
	echo '<li><div class="buttonbg gradient_button gradient27" style="width: 80px;"><div class="arrow"><a>入荷作業</a></div></div>
  ...
  <li><div class="buttonbg gradient_button gradient27" style="width: 80px;"><div class="arrow"><a>出荷作業<br /></a></div></div>
    ...
    <li class="gradient_menuitem gradient31 first_item"><a href="/fill/index.php?url=lorry_fill_check" target="_self" title="">補充填作業</a>
    	<ul class="gradient_menu gradient157">
    		<li class="gradient_menuitem gradient31 first_item"><a href="/fill/index.php?url=drum_washed_edit" target="_self" title="">編輯DRUM洗淨桶號</a></li>  
    	</ul>
    </li>
	<li class="gradient_menuitem gradient31 first_item"><a href="/fill/index.php?url=cal_toto_lorry_ext" target="_self" title="">TOTO-LORRY 補充填作業</a></li>
    ...
    <li class="gradient_menuitem gradient31"><a href="/fill/index.php?url=TSMC30" target="_self" title="">TSMC槽車洗淨</a></li>
    ...
    <li class="gradient_menuitem gradient31"><a href="/fill/index.php?url=fill_modify_" target="_self" title="">充填壓力變更</a></li>
    <li class="gradient_menuitem gradient31"><a href="/fill/index.php?url=delete_bad_lorry" target="_self" title="">刪除舊充填作業檢查表</a></li>
    </ul></li>
  <li><div class="buttonbg gradient_button gradient27" style="width: 80px;"><div class="arrow"><a>回收作業</a></div></div>
    ...
    <li class="gradient_menuitem gradient31 last_item"><a href="/recover/index.php?url=sample_location" target="_self" title="">樣品瓶儲位</a></li>
    </ul></li>
    ...
    <li class="gradient_menuitem gradient31 first_item"><a href="/cal/index.php?url=list_" target="_self" title="">分析依賴查詢畫面及結果</a>
	  ...
	  <li class="gradient_menuitem gradient31 "><a href="/cal/index.php?url=change_customer" target="_self" title="">出貨客戶變更</a></li>
      </ul></li>
	  <li class="gradient_menuitem gradient31"><a href="/cal/index.php" target="_self" title="">分析檢查作業表 製作/查詢</a>
      <ul class="gradient_menu gradient157">
	  ...
	  <li class="gradient_menuitem gradient31 first_item"><a href="/cal/index.php?url=cal_cust_input" target="_self" title="">客戶委託(特殊)分析檢查作業表製作/查詢</a></li>
      ...
      <li class="gradient_menuitem gradient31"><a href="/cal/index.php?url=form_update" target="_self" title="">檢查表範本上傳</a></li>
      </ul>
    </li>
    ...
    <li class="gradient_menuitem gradient31 last_item"><a href="/cal/index.php?url=trans_ana" target="_self" title="">修改LOT NO(分析資料)</a>
    <ul class="gradient_menu gradient157">
    <li class="gradient_menuitem gradient31 last_item"><a href="/cal/index.php?url=change_lotno_list" target="_self" title="">LOT NO修改查詢</a></li>
    </ul></li>
     </ul></li>
    ...
    <li class="gradient_menuitem gradient31 first_item last_item"><a  href="/istar/index.php?url=istar" target="_self" title="">產生 iStar 上傳檔案</a></li>
    <li class="gradient_menuitem gradient31 first_item last_item"><a  href="/istar/index.php?url=istar_setting" target="_self" title=""> iStar 參數</a></li>
    <li class="gradient_menuitem gradient31 first_item last_item"><a  href="/COA/index.php?url=pcn_no" target="_self" title=""> PCN 碼輸入</a></li>
  </ul></li> '; 
 }
?>
  ...
  <li><div class="buttonbg gradient_button gradient27" style="width: 80px;"><div class="arrow"><a>製造課</a></div></div>
    ...
    <li class="gradient_menuitem gradient31 first_item last_item"><a  href="/PRODUCE/index.php?url=daily_input" target="_self" title="">硫酸生產輸入</a></li>
      ...
      <li class="gradient_menuitem gradient31 "><a  href="/PRODUCE/index.php?url=lorry_out_count" target="_self" title="">Lorry 使用紀錄</a></li>
      </li> 
      <li class="gradient_menuitem gradient31 "><a  href="/PRODUCE/index.php?url=cal_in_flow" target="_self" title="">HIC 硫酸充填路徑</a></li>
      </ul></li> 
<?php
 if(substr($_SESSION['uid'],0,1)<>'H'){
	echo '
  <li><div class="buttonbg gradient_button gradient27" style="width: 80px;"><div class="arrow"><a>樣品瓶作業</a></div></div>
    ...
    <li class="gradient_menuitem gradient31 first_item"><a href="/samples/sample_location.php" target="_self" title="">樣品瓶接收/儲存</a></li>
    </ul></li>
  <li><div class="buttonbg gradient_button gradient27" style="width: 80px;"><div class="arrow"><a>系統維護<br /></a></div></div>
    ...
    <li class="gradient_menuitem gradient31"><a href="/system/index.php?url=capacity" target="_self" title="">製品桶槽容量設定</a></li>
    ...
    <li class="gradient_menuitem gradient31 first_item last_item"><a  href="/PRODUCE/index.php?url=UTT_check_input" target="_self" title="">自動輸出EXCEL設定</a>
      <ul class="gradient_menu gradient157">
      <li class="gradient_menuitem gradient31 "><a  href="/system/index.php?url=output_setup" target="_self" title="">檔案設定</a></li> 
      <li class="gradient_menuitem gradient31 "><a  href="/system/index.php?url=column_setup" target="_self" title="">欄位設定</a></li>  
      </ul>
   </li> 
