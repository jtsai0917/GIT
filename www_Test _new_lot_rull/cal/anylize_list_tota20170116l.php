...
$styleThinBlackBorderOutline = array(
	...
	$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValue('e7',iconv("big5","utf-8","和否判定"))
...
//    if(($ani_datefield=='PO4') or ($ani_datefield=='SO4' or ($ani_datefield=='CL'))){$table=$tb->tbno;}
	...
	if($unit=='none'){$unit='-------';}
	if($dl=='none'){$dl='-------';}
	list ($report,$SampleNo,$Tester,$AnalyzeTime,$Ok,$Ok_value)=get_report_value($table,$_GET['lot_no'],$ani_datefield,$spc,$dl,$usl,$lsl,$showmode,$stdu,$stdl);
