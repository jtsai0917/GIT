...
'Ok') && ($row['COLUMN_NAME']!='AnalyzeTime') && ($row['COLUMN_NAME']!='AnalyzeTime') && ($row['COLUMN_NAME']!='AnaManager') && ($row['COLUMN_NAME']!='Tester') && ($row['COLUMN_NAME']!='Operator')
 && ($row['COLUMN_NAME']!='SampleNo') && ($row['COLUMN_NAME']!='SerialNo') && ($row['COLUMN_NAME']!='TestDate')){
	$i=$i+1;
?>
      <td><?php echo '<font color="#0000FF">'.$row['COLUMN_NAME'].'</font>';?> ：</td><td><input name="<?php echo $row['COLUMN_NAME'];?>" type="text" id="<?php echo $row['COLUMN_NAME'];?>" size="6" value=
