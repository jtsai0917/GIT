...
<td><input type="checkbox" name="chkbox[]" id="1" value="<?php echo $row['ANI_INDEX'] ?>" <?php echo testnotonick($row['ANI_INDEX'],$_SESSION['prod_no'],$_SESSION['testitems'].",")?>/></td></tr>
<?php
}
?>
</table>
...
if(isset($_POST["normal"])){
	...
	$numRows = mssql_num_rows($result);
	while($row = mssql_fetch_array($result)){
	$_SESSION['testitems'].= $row['ANI_INDEX'].",";
	}

$url="main.php?url=any_no";
jumpto($url);
}
