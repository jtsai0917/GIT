...
$query="INSERT INTO [dbo].[Sample] ([SMP_ID], [SMP_MAT], [SMP_MID_ID], [SMP_START], [SMP_TIMES], [SMP_SERVICE], [SMP_LOT], [SMP_DRUMNO], [SMP_USER], [SMP_OUT], [SMP_SMP], [SMP_ANA], [SMP_BACK], [SMP_SAVE], [SMP_SAVE_TIME], [SMP_FINISH], [SMP_JUNK], [SMP_JUNK_D]) VALUES (N'".$_GET['smp_id']."', N'".$met."', N'".$_SESSION['s2']."', N'".date("Ymd")."', 0, NULL, '".$_SESSION['lot_no']."', '".$_GET['sn']."', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)"; 
